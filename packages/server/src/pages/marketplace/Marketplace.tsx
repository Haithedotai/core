...
export default function MarketplacePage() {
  ...
  const handlePurchase = async (item: MarketplaceItem) => {
    ...
    try {
      ...
      loadItems(); // Refresh to update download count
    } catch (error) {
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="flex flex-col gap-8">
            <div className="space-y-3">
              <h1 className="text-4xl font-bold text-foreground leading-tight">Marketplace</h1>
            ...
            <div className="flex flex-col @sm/main:flex-row gap-6">
              <div className="flex-1">
                <div className="relative">
                  <Icon name="Search" className="absolute left-4 top-1/2 transform -translate-y-1/2 size-4 text-muted-foreground" />
                  <Input
