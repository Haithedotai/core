...
export const waitForTransaction = {
  description: "Waits for a transaction to be mined and returns receipt (configurable confirmations).",
  schema: waitTxSchema,

  run: async (config: { rpcUrl: string }, input: z.infer<typeof waitTxSchema>) => {
